...
class StatementsService:
    ...
    def _line_to_response(self, line: StatementLineDB, account_id: int) -> StatementLineResponse:
        ...
        for ch in getattr(line, "child_lines", []) or []:
            child_responses.append(
                StatementLineResponse(
                    ...
                    applied_rule_id=getattr(ch, "applied_rule_id", None),
                    is_auto_applied=getattr(ch, "is_auto_applied", False),
        ...
        return StatementLineResponse(
            ...
            applied_rule_id=getattr(line, "applied_rule_id", None),
            is_auto_applied=getattr(line, "is_auto_applied", False),
